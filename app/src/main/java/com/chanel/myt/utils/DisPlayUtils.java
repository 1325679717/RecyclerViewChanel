...
//            MIUISetStatusBarLightMode(activity);
    ...
    public static int getScreenHeight(Context context) {
        ...
        DisplayMetrics outMetrics = new DisplayMetrics();
        wm.getDefaultDisplay().getMetrics(outMetrics);
        Log.i("DisPlayUtils","getScreenHeight = "+outMetrics.heightPixels);
        return outMetrics.heightPixels;
    }
    public static int getEffectiveHeight(Context context){

     return getDpi(context) - getBottomStatusHeight(context) - getStatusBarHeight(context);
    }/**
     * 获取 虚拟按键的高度
     * @param context
     * @return
    ...
    public static int getDpi(Context context){
        ...
        try {
            ...
            Log.i("DisPlayUtils","getDpi = "+displayMetrics.heightPixels);
        }catch(Exception e){
            e.printStackTrace();
        }
        return dpi;
